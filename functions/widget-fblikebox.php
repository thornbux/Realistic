...
/*-----------------------------------------------------------------------------------
	...
	Plugin Name: Realistic Facebook Like Box
	Description: A widget that displays your Facebook Like Box for Facebook Page.
	Version: 2.0

-----------------------------------------------------------------------------------*/

class realistic_fblikebox_widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'realistic_fblikebox_widget',
            __('Realistic: Facebook Like Box', 'realistic' ),
            array( 'description' => __( 'Displays Facebook Like Box.', 'realistic' ), )
        );
    }	
	public function form( $instance ) {

		$title 		= ! empty( $instance['title'] ) ? $instance['title'] : __( 'Find us on Facebook!', 'realistic' );
     	$app_id 	= ! empty( $instance['app_id'] ) ? $instance['app_id'] : '457864337722844';
     	$href 		= ! empty( $instance['href'] ) ? $instance['href'] : '';
     	$width 		= ! empty( $instance['width'] ) ? $instance['width'] : '304';
	    ...
	    <p>
		    <label for="<?php echo $this->get_field_id( 'app_id' ); ?>"><?php _e('App Id', 'realistic') ?></label>
	    ...
	    <p>
	    	...
	    	<small><?php _e('The absolute URL of your Facebook Page. e.g: https://www.facebook.com/themient', 'realistic') ?></small>
	    </p>
	    <p>
	    	<label for="<?php echo $this->get_field_id( 'width' ); ?>"><?php _e('Width', 'realistic') ?></label>
	    	...
	    	<small><?php _e('The width of the widget in pixels. Minimum is 292.', 'realistic') ?></small>
	    </p>
	    <p>
	    	<label for="<?php echo $this->get_field_id( 'height' ); ?>"><?php _e('Height', 'realistic') ?></label>
	    	...
	    	<small><?php _e('The height of the plugin in pixels. The default height varies based on number of faces to display, and whether the stream is displayed.', 'realistic') ?></small>
	    </p>
	    <p>
	    	<label for="<?php echo $this->get_field_id( 'color' ); ?>"><?php _e('Color Scheme', 'realistic') ?></label>
	    ...
	    <p>
	    	...
	    	<label for="<?php echo $this->get_field_id( 'showfaces' ); ?>"><?php _e('Show Friends\' Faces', 'realistic') ?></label>
	    </p>
	    <p>
	    	...
	    	<label for="<?php echo $this->get_field_id( 'stream' ); ?>"><?php _e('Show Posts', 'realistic') ?></label>
	    </p>
	    <p>
	    	...
	    	<label for="<?php echo $this->get_field_id( 'header' ); ?>"><?php _e('Show Header', 'realistic') ?></label>
	    </p>
	    <p>
	    	...
	    	<label for="<?php echo $this->get_field_id( 'showborder' ); ?>"><?php _e('Show Border', 'realistic') ?></label>
	    </p>
	    <?php
	}
...
add_action( 'widgets_init', create_function( '', 'register_widget("realistic_fblikebox_widget");' ) );